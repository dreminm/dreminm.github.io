$(function () {
    ...
    $(document).ready(function() {
        ...
        var video_to_name = ['animation_clip', 'skiing', 'street_show'];

        var print_codec_to_name = ['x264', 'x265', 'aomenc', 'VVenC', 'uavs3e'];
        var print_metric_to_name = ['ERQAv1.0', 'VMAF', 'VMAF NEG', 'Y-PSNR', 'YUV-MS-SSIM', 'LPIPS'];
        var print_video_to_name = ['animation clip', 'skiing', 'street show'];
