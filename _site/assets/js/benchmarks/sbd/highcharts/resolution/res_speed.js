$(function () {
    $(document).ready(function() {
    	...
    	Highcharts.chart('container_res', {
    		credits: {
                           enabled: true,
                           href: "https://videoprocessing.ml/benchmarks/",
                           text: "https://videoprocessing.ml/benchmarks/"},
		    chart: {
		        zoomType: 'xy'
		    },
		    title: {
		    ...
		    series: [ {
		        name: 'VQMT',
		        data: [[34.572, 1280], [49.09, 854], [61.13, 640], [76.671, 426]]
		    }, //{
		      //  name: 'Beta Proposed',
		     //   data: [[15.421, 1280], [19.062, 854], [26.234, 640], [35.2342, 426]]
		   //},
		    {
		        name: 'Saeid Dadkhan',
		        color: 'rgba(0, 254, 0, 5)',
		        data: [[60.415, 1280], [65.032, 854], [71.54, 640], [79.341, 426]]
		   }
		]}
		);
